...
public abstract class EnemyBase : MonoBehaviour, IRespawn, IDoDamage, IChangePoints, IExplode, ISpawnable
{
    ...
    [SerializeField] private float _respawnHeight = 9.5f;
    ...
    protected virtual void Update() => _movement.Move();


    protected virtual void OnTriggerEnter2D(Collider2D other)
    {
        CheckForDamageableInteraction(other);
    }

    private void CheckForDamageableInteraction(Collider2D other)
    {
